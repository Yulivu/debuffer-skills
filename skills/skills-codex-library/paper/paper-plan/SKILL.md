...
Before committing to a structure, apply the narrative principle from `../../skills-codex/shared-references/writing-principles.md`:
...
**Title**: [working title]
**One-sentence contribution**: [core takeaway supported by the storyboard]
**Venue**: [target venue]
