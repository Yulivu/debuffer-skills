...
`../../skills-codex/shared-references/autosci-lite-patterns.md` before Phase 2 and use it for
...
`../../skills-codex/shared-references/wiki-helper-resolution.md`):
...
Save a Review Tracing record for this `spawn_agent` call following `../../skills-codex/shared-references/review-tracing.md`, including the landscape summary, prompt summary, raw idea list path, reviewer route, and saved agent id.
...
After each `spawn_agent` or `send_input` reviewer call, save the trace following `../../skills-codex/shared-references/review-tracing.md`. Include the reviewer route, saved agent id, prompt summary, raw output path, selected ideas, and rejected ideas.
