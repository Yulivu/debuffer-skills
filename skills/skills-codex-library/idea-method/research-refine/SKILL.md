...
Read `../../skills-codex/shared-references/autosci-lite-patterns.md`. A-E paths
may be used to choose a route for this selected problem; broad candidate
generation remains owned by `idea-creator`.
...
check problem fidelity, method specificity, contribution parsimony, novelty
boundary, feasibility, falsifiability, and scope drift.
