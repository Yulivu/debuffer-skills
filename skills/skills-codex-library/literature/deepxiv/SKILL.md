...
- **DEEPXIV_FETCHER** — canonical name `deepxiv_fetch.py`, resolved per
  [`shared-references/integration-contract.md`](../../skills-codex/shared-references/integration-contract.md) §2
...
(see [`shared-references/integration-contract.md`](../../skills-codex/shared-references/integration-contract.md) §2):
...
Follow [`shared-references/integration-contract.md`](../../skills-codex/shared-references/integration-contract.md). If the wiki path or schema is unclear, ask before writing.
