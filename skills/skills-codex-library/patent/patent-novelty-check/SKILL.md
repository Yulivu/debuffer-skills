...
Load `../../skills-codex/shared-references/patent-writing-principles.md` for novelty/non-obviousness standards.
Load `../../skills-codex/shared-references/patent-format-us.md` for 102/103 analysis framework.
