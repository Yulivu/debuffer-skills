...
Load `../../skills-codex/shared-references/patent-format-cn.md` for CNIPA document structure and formatting rules.
Load `../../skills-codex/shared-references/patent-format-us.md` for USPTO document structure.
Load `../../skills-codex/shared-references/patent-format-ep.md` for EPO document structure.
