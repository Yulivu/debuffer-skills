...
Load `../../skills-codex/shared-references/patent-writing-principles.md` for claim drafting principles, antecedent basis rules, and common pitfalls.
Load `../../skills-codex/shared-references/patent-format-cn.md` for CN claim format (其特征在于).
Load `../../skills-codex/shared-references/patent-format-us.md` for US claim format (comprising, means-plus-function).
Load `../../skills-codex/shared-references/patent-format-ep.md` for EP two-part form (characterised in that).
