...
**Full catalog**: [docs/SKILLS_CATALOG.md](docs/SKILLS_CATALOG.md) - **82 skills**.
...
| 证据审计 | `/experiment-audit`, `/experiment-writeup-audit`, `/paper-claim-audit`, `/citation-audit`, `/figure-table-audit` | 审计 prompt、证据矩阵、图表/实验写法问题单、修复清单 |
| 论文写作 | `/paper-writing`, `/paper-visualization`, `/overleaf-package` | 论文计划、LaTeX、图表、实验章节写法校验、Overleaf 上传包、提交前检查 |
